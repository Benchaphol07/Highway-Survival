...
def update():
    global StatusGame, Score, high_score, hp, Time, speed, accel, random_speeds, crash, spin, side, smoke, car, car_broken, last, last_heart, hearts, coins, last_coin
    ...
    if StatusGame == 1 :
        ...
        for enemy in enemies :
            ...
            # if hp = 0
                ...
                # new high score
                if Score > high_score :
                    #decrease speed and stop engine sound
                    if speed > 0:
                        if speed > 18:
                            speed -= 0.05
                        elif speed > 14:
